...
export const bikes: Bike[] = [
  ...
  },
  {
    ...
    story:
    "Miguel Hughes adopted our little buddy Lil Blue, a low-mile 1986 Suzuki GSX-R750 that had been tucked away and forgotten about for a few decades. After some fresh paint, a full service, new tires, and plenty of TLC, this little dude was ready to find his forever home. Today, Lil Blue is proudly running around Iowa — only during good weather, of course!",    restoration: 65,
        storyParagraphs: [
      "Miguel Hughes adopted our little buddy \"Lil Blue,\" a low-mile 1986 Suzuki GSX-R750 that had been tucked away and forgotten about for a few decades.",
      "After some fresh paint, a full service, new tires, and plenty of TLC, this little dude was ready to find his forever home.",
      "Today, Lil Blue is proudly running around Iowa — only during good weather, of course! And when he\'s not out stretching his legs, he resides comfortably in a heated, climate-controlled environment.",
      "This little guy has never had it so good.",
      "We rescue \'em for you to love \'em!",
    ],
    timeline: [
      ...
      { day: "Day 90", title: "Looking better every day", note: "Paint correction, fresh rubber.", phase: "after" },
      { day: "Forever home", title: "Ready for new adventures", note: "Cleared for adoption.", phase: "graduation" },
    ],
  },
  {
